...
/*
 * @scope  From json file to rapidjson document object
...
/*
 * @scope  From json file to unordered_map (string->uint),
...
/*
 * @scope  Create normal adjacency matrix and dangling vector
 *         from json file, thanks to _uMapJson method
 * @param  <json_path>  The input json filename
 * @param  <info>       Stdout informations, default: false
 * @param  <master_key> Master key, default: "objects"
 * @param  <node_key>   Node key, default: "url"
